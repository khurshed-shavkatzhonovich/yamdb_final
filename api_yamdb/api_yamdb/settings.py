...
SECRET_KEY = config('SECRET_KEY', default='p&l%385148kslhtyn^##a1)ilz@4zqj=rq&agdol^##zgl9(vs')
...
EMAIL_FROM = 'superAdmin@yandex.ru'
EMAIL_DEFAULT_SUBJECT = 'Вы зарегистрировались на YAMDB!'
